# -*- coding: utf-8 -*-
"""
Created on Thu Dec 29 11:00:39 2022
...
for i in range(len(file_1.variables['time'])):
    ...
    # intevalos do geopt em 500 shaded
    intervalo_min2 =  4500
    intervalo_max2 =  5900
    interval_2 = 20             # de quanto em quanto voce quer que varie
    levels_2 = np.arange(intervalo_min2, intervalo_max2, interval_2)
    
    # intevalos da pnmm contour em sup
    intervalo_min1 = 900
    intervalo_max1 = 1020
    ...
    # Add a title
    plt.title('Pnnm e Geopotencial em 500 hPa',
              fontweight='bold', 
              fontsize=30, 
              loc='left'
              )
